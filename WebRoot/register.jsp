...
<script type="text/javascript">
	$(function() {
		var email = $("#email");
		var real_password = $("#real_password");
		...
		submit.mouseover(function() {
			submit.attr("src", "img/li2.png");
		});
		submit.mouseout(function() {
			submit.attr("src", "img/li1.png");
		});
		...
		submit.click(function() {
			$.ajax({
				type : "post",
				//url : "http://192.168.0.103:8080/xysta/register",
				url : "register",
				data : {
					email : email.val(),
					...
					sex : $("#sex_radio input[type='radio']:checked").val(),
					area : area.val()
				},
				cache : false,
				dataType : "json",
				success : function(data) {
					...
					if (res) {
						...
						alert("注册成功,用户信息："+data.message.email);
					} else {
						//console.log(data.message);
						alert("注册失败,附加信息："+data.message);
					}
				}
			});
		});
...
<body style="background-image: url('img/bgimg99.jpg');">
	...
	<div style="z-index:0;width:900;height:800;position: absolute;">
		<div style="width: 900;height:800;background-color: white;" id="div5">
			<img src="img/fa.png" style="margin-left:-10"></img>
		</div>
		<div id="div6">
						...
						<div id="div1"
							...
							<div id="div2">
								...
								<br> <br> <img src="img/li1.png"
									style="margin-left: 30%" id="register"></img>
							</div>
						</div></td>
					<td>
						<div id="div2"
							...
							<br> <br> <br> <br> <br> <br> <span><font
								color="gray" size="5">&nbsp;&nbsp;已有邮箱用户,<br>&nbsp;&nbsp;可以直接登录:</font><img
